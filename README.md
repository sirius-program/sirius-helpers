...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/sirius-helpers.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/sirius-helpers)
...
```bash
php artisan vendor:publish --tag="sirius-helpers-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="sirius-helpers-views"
```

## Usage

```php
$siriusHelpers = new SiriusProgram\SiriusHelpers();
echo $siriusHelpers->echoPhrase('Hello, SiriusProgram!');
```
